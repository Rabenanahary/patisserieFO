...
<head>
<title>Gateaux et Recettes</title>
<meta charset="UTF-8">
  ...
  <div class="row">
    <div class="holder_content1">
      <section class="group4">
        <h3>Gateaux à la Une</h3>
        <article>
          <h4>Les Meilleurs Gateaux <span>Profitez, Savourez, Regalez vous </span></h4>
        </article>
      </section>
    </div>
    <!--end holder-->
  ...
  <div class="row">
    <div class="fourcol">
      <section class="group1">
        ...
        <a href="Recette-<?php echo $gateaux["idGat"] ?>.php"><span class="button">Recette</span></a> 
      </section>
    </div>
  </div>
</div>
